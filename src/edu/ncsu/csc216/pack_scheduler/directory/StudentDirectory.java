...
public class StudentDirectory {
	 ...
	 * @throws IllegalArgumentException if the password is null, empty, or if the passwords do not match
	 */
	...
	/**
	 * Gets the student from the directory matching the given id, or null if there is no such student
