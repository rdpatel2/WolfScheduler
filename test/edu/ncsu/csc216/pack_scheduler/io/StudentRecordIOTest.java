...
class StudentRecordIOTest {
	...
	/**
	 * Tests readStudentRecords for valid and invalid files
	 */
	@Test
	void testReadStudentRecords() {
		//testing for a valid Student Record
		try {
			SortedList<Student> students = StudentRecordIO.readStudentRecords(validFile);
		...
		//testing for an invalid Student Record
		SortedList<Student> students;
		try {
			students = StudentRecordIO.readStudentRecords(invalidFile);
	...
	/**
	 * tests writeStudentRecords for a valid written file
	 */
	@Test
	...
	/**
	 * test writeStudentRecords with no permissions
	 */
	@Test
