...
public class StudentDirectoryTest {
	...
	private final String invalidTestFile = "invalid file";
	/** Test first name */
	...
	public void testLoadStudentsFromFile() {
		...
		Exception exception = assertThrows(IllegalArgumentException.class, () -> sd.loadStudentsFromFile(invalidTestFile));
	...
	public void testAddStudent() {
		...
		Exception e5 = assertThrows(IllegalArgumentException.class,
				() -> sd.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, PASSWORD, PASSWORD + "_", MAX_CREDITS));
		assertEquals("Passwords do not match", e5.getMessage());
		
		//Test credits is too low (a student object should be created anyways)
		assertTrue(sd.addStudent(FIRST_NAME, LAST_NAME, ID + "1", EMAIL, PASSWORD, PASSWORD, 2));
		
		//Test credits is too high (a student object should be created anyways)
		assertTrue(sd.addStudent(FIRST_NAME, LAST_NAME, ID + "2", EMAIL, PASSWORD, PASSWORD, 19));
		...
		//Test add student with duplicate ID
		boolean result = sd.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, PASSWORD, PASSWORD, MAX_CREDITS);
		assertFalse(result);
	}
	...
	public void testRemoveStudent() {
		...
		//Try removing a student that does not exist
	...
	public void testGetStudentById() {
		...
		s.addStudent("First", "Last", "flast", "flast@ncsu.edu", "password", "password", 18);
		
		s.addStudent("First2", "Last2", "flast2", "flast2@ncsu.edu", "password", "password", 18);
		
		s.addStudent("First3", "Last3", "flast3", "flast3@ncsu.edu", "password", "password", 18);
		
		Student found = s.getStudentById("flast2");
		
		Student expected = new Student("First2", "Last2", "flast2", "flast2@ncsu.edu", "XohImNooBHFR0OVvjcYpJ3NgPQ1qq73WKhHvch0VQtg=", 18);
	...
	public void testGetStudentDirectory() {
		...
		sd.loadStudentsFromFile(validTestFile);
		String[][] students = sd.getStudentDirectory();
		assertEquals("Demetrius", students[0][0]);
		assertEquals("Austin", students[0][1]);
		assertEquals("daustin", students[0][2]);
	}
