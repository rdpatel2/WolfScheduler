...
class StudentTest {
	...
	void testHashCode() {
		...
		Student s3 = new Student("different", LAST_NAME, ID, EMAIL, PASSWORD, MAX_CREDITS);
		Student s4 = new Student(FIRST_NAME, "different", ID, EMAIL, PASSWORD, MAX_CREDITS);
		Student s5 = new Student(FIRST_NAME, LAST_NAME, "different", EMAIL, PASSWORD, MAX_CREDITS);
		Student s6 = new Student(FIRST_NAME, LAST_NAME, ID, "different@ncsu.edu", PASSWORD, MAX_CREDITS);
		Student s7 = new Student(FIRST_NAME, LAST_NAME, ID, EMAIL, "different", MAX_CREDITS);
		Student s8 = new Student(FIRST_NAME, LAST_NAME, ID, EMAIL, PASSWORD, 10);
	...
	void testStudentStringStringStringStringStringInt() {
		...
		//test invalid max credits
		Exception e7 = assertThrows(IllegalArgumentException.class,
						() -> new Student(FIRST_NAME, LAST_NAME, ID, EMAIL, PASSWORD, 2));
		assertEquals("Invalid max credits", e7.getMessage());
	}
	...
	@Test
	void testCompareTo() {
		Student s1 = new Student("Brendon", "Hablutzel", "bdhablut", "bdhablut@ncsu.edu", "password");
		Student s2 = new Student("Parker", "Morrison", "psmorris", "psmorris@ncsu.edu", "password");
		Student s3 = new Student("Gustavo", "Zuniga", "gzuniga", "gzuniga@ncsu.edu", "password");
		Student s4 = new Student("May", "Hablutzel", "mahablut", "mahablut@ncsu.edu", "password");
		Student s5 = new Student("May", "Hablutzel", "mhablutz", "mhablutz@ncsu.edu", "password");
	...
	void testToString() {
		...
		assertEquals(
				FIRST_NAME + "," + LAST_NAME + "," + ID + "," + EMAIL + "," + PASSWORD + "," + MAX_CREDITS,
				s.toString());
	}

	/**
	 * Tests if two objects of Student are the same
	 */
	@Test
